...
export function NotificationCenter() {
  ...
  return (
    <div>
      ...
      >
        <Header>
          <h3>Central de Notificação</h3>
          <UnreadFilter>
            <label htmlFor="unread-filter">Somente não lida</label>
            <Switch
              id="unread-filter"
          ...
          >
            {(!notifications.length ||
              ...
              <motion.h4
                ...
                exit={{ opacity: 0 }}
              >
                Sem nenhuma notificação! Por aqui tudo certo! {" "}
                <span role="img" aria-label="algum label">
                  🎉
                </span>
              </motion.h4>
            )}
        ...
        <Footer>
          ...
          <button onClick={markAllAsRead}>Marcar como lida</button>
        </Footer>
      </Container>
    </div>
  );
